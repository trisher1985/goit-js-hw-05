...
// Функція sortByDescendingFriendCount: Приймає масив об'єктів users. Використовує метод toSorted() 
// для створення нового відсортованого масиву. У функції сортування порівнюється кількість друзів 
// (friends.length) у кожного користувача.
